...
def test_can_make_arithmetic_progression():
    assert can_make_arithmetic_progression([1, 3, 5]) is True
    assert can_make_arithmetic_progression([3, 6, 1]) is False
    assert (
        can_make_arithmetic_progression([7, 43, 19, 25, 1, 31, 37, 13]) is True
    )
    assert (
        can_make_arithmetic_progression([7, 43, 19, 25, 1, 32, 37, 13])
        is False
    )
